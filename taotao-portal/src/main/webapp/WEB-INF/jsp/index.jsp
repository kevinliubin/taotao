...
<title>淘淘网上商城-综合网购首选-正品低价、品质保障、货到付款、配送及时、放心服务、轻松购物！</title>
				...
				<script type="text/javascript">
					(function(cfg, doc) {
						...
						if (cfg.DATA_MSlide.length > 1) {
							...
							var TPL = '' + '<ul class="slide-items">' + '<li clstag="homepage|keycount|home2013|09a1">' + '<a href="'+ first.href +'" target="_blank" title="'+ first.alt +'">' + '<img src="'+ first.src +'" width="'+ first.width +'" height="'+ first.height +'" >' + '</a>' + '</li>' + '</ul><div class="slide-controls"><span class="curr">1</span></div>';
							doc.write(TPL);
						}
					})(pageConfig, document);
				</script>
	...
	<div id="floors-list">
		<div class="w w1" data-fid="0" id="electronics">
			<div class="m m1 catalogue" data-lazyload="1">
				<div class="mt ld">
					<div class="floor">
						<b class="fixpng b b1"></b><b class="fixpng b b2"></b><b class="b b3">1F</b><b class="fixpng b4"></b>
					</div>
					<h2>家电通讯</h2>
				</div>
				<div class="mc">
					<div class="style1">
						...
						<span clstag="homepage|keycount|home2013|18b"> <!-- 广告信息 --> <a target="_blank" title="" href="http://c.fa.jd.com/adclick?sid=2&cid=601&aid=3624&bid=0&unit=35989&advid=105087&guv=&url=http://sale.jd.com/act/PzKvRu4Ld5YnG1Ej.html"> <img data-img="2" data-lazyload="/images/543b4d75N686689d7.jpg" width="209" height="155" alt="" />
						</a>
						</span>
					</div>
				</div>
